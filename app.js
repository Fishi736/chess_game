...
function move(number0fSteps, direction) {
    ...
    switch (direction) {
        case "E": temp = queen.position.y + number0fSteps;
            if (temp > 8 || temp < 0) {
        ...
        case "W": temp = queen.position.y - number0fSteps;
            if (temp > 8 || temp < 0) {
                console.log("Out of Boundary");
                document.write("Out of Boundary");
            }
            ...
            break;
        case "S": temp = queen.position.x+ number0fSteps;
            if (temp > 8 && temp < 0) {
                console.log("Out of Boundary");
                document.write("Out of Boundary");
            }
            ...
            break;
        case "N": temp = queen.position.x - number0fSteps;
            if (temp > 8 || temp < 0) {
                console.log("Out of Boundary");
                document.write("Out of Boundary");
            }
        ...
        case "SE": temp = queen.position.x + number0fSteps;
                   temp1 = queen.position.y + number0fSteps;
        ...
        case "NE": temp = queen.position.x - number0fSteps;
                   temp1 = queen.position.y + number0fSteps;
            if ((temp > 8 || temp < 0) && (temp1 > 8 || temp < 0)) {
                console.log("Out of Boundary");
                document.write("Out of Boundary");
        ...
        case "SW": temp = queen.position.x + number0fSteps;
                   temp1 = queen.position.y - number0fSteps;
            if ((temp > 8 || temp < 0) && (temp1 > 8 || temp < 0)) {
                console.log("Out of Boundary");
                document.write("Out of Boundary");
        ...
        case "NW": temp = queen.position.x - number0fSteps;
            temp1 = queen.position.y - number0fSteps;
            if ((temp > 8 || temp < 0) && (temp1 > 8 || temp < 0)) {
                console.log("Out of Boundary");
                document.write("Out of Boundary");
